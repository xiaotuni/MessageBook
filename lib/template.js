...
var HtmlEngine = function (Html) {
    ...
    while (match = reg.exec(Html)) {
        ...
        _index = match.index + match[0].length || 0;
    }
...
function _BuilderNodeJsBlock(Html, Options, Callback) {
    ...
    Comm.Log.Print('_BuilderNodeJsBlock');
    console.log("------_BuilderNodeJsBlock----------24143--------------");
